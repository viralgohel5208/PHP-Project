...
else
{
	while($row = mysqli_fetch_assoc($result))
	{
		echo '<div class="table-responsive">
			<h4>Order Number: '.$row['order_number'].' <button onclick="window.location = \'my-orders-view.php?id='.safe_encode($row['id']).'\'" class="button" style="float: right; padding: 4px 10px; margin-top: 0"><i class="fa fa-pencil"></i>&nbsp; <span>View Details</span></button></h4>
			...
			<br />
								...
								<div class="table-responsive">
									...
									<p> Cart Total : ₹ 555.00
										<br />
										Order Date : 2018-01-26 17:07:52
										<br />
										Status</p>
									<br />
								</div>
