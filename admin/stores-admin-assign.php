...
$page_title = "Assign Store Admin";

if(isset($_POST['delete_id']))
{
	$id = escapeInputValue($_POST['delete_id']);
	
	$result = "DELETE FROM stores_admin WHERE id = '" . $id . "' AND app_id = $app_id";
            ...
            <header id="topbar">
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<a href="stores-admin-assign-add.php" class="pl5 btn btn-default btn-sm">
						...
						<div class="panel panel-visible panel-dark">
							<div class="panel-heading panel-visible">
								...
								<div class="widget-menu pull-right mr10">
									<div class="btn-group">
										<a href="stores-admin-assign-add.php" class="btn btn-xs btn-default">
    ...
    <script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"stores-admin-assign-datatable.php", // json datasource
