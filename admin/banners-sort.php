...
$page_title = "Sort Banner Sequence";
		...
		<section id="content_wrapper">
			...
			<div id="content" class="animated fadeIn">
				<div class="row">
					...
					<div class="col-md-12">
						<?php 
						$query_4 = "SELECT * FROM banners ORDER BY display_order";
						...
						else
						{
							...
							while($row_4 = mysqli_fetch_assoc($result_4))
							{
								...
								//echo $row_4['banner_name'];
								echo '<img src="../uploads/store-'.$app_id.'/banners/'.$row_4['file_name'].'" class="img-responsive" title="'.$row_4['banner_name'].'" style="width:200px">';
								echo '</div>';
								echo '</li>';
							}
							echo '</ol></div>';
		...
		$(document).ready(function()
		{
			...
			var updateOutput = function(e)
			{
				...
				if (window.JSON) {
					...
					$.ajax({
						type: "POST",
						url: "include/sortable-banners.php",
