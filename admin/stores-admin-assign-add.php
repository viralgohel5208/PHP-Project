...
$page_title = "Assign Admin To Store";

if ( isset( $_POST[ 'save' ] ) )
{
	$store_id 		= escapeInputValue( $_POST[ 'store_id' ] );
	$admin_id		= escapeInputValue( $_POST[ 'admin_id' ] );
	...
	if( $error == "" )
	{
		$q_11 = "SELECT id FROM stores_admin WHERE app_id = $app_id AND store_id = '$store_id' AND admin_id = '$admin_id'";
	...
	if ( $error == "" )
	{
		$sql_ins = "INSERT INTO `stores_admin` (`app_id`, `store_id`, `admin_id`, `created_at`) VALUES ($app_id, $store_id, $admin_id, '$current_datetime' )";
		...
		{
			$_SESSION['msg_success'] = "Admin has been assigned successfully";
			header("location:stores-admin-assign-add.php");
			exit;
		}
	}
}
            ...
            <header id="topbar">
				<div class="topbar-left">
					<ol class="breadcrumb">
						...
						<li class="crumb-link">
							<a href="stores-admin-assign.php">Stores Admin</a>
						</li>
                        ...
                        <div class="panel panel-visible panel-dark">
                            ...
                            <div class="panel-body">
								<form class="form-horizontal" role="form" method="post" action="" >
									...
									<?php 
									$result1 = mysqli_query($link, "SELECT id, store_name FROM stores WHERE app_id = $app_id ORDER BY store_name");
									if($result1)
									{ 
									?>
