...
$sql = "SELECT id, user_name, first_name, last_name, email, mobile, status FROM `customers` ";
$sqlTot .= $sql;
$sqlRec .= $sql;
...
while( $row = mysqli_fetch_row($queryRecords) ) {
	...
	$row[7] = '<a href="users-update.php?id='.$pri_id.'" class="btn btn-success btn-xs"> &nbsp;<i class="fa fa-pencil"></i></a>';
