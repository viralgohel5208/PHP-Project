...
$store_id = 1;
$order_id = 10;
$order_number = 'ORD-1521032372';
$ord_price_total = '199.00';
...
else
{
	...
	if($email != "" || $mobile != "")
	{
		...
		{
			//$error_code = 6; 
			echo $error_string = 'Email send error, Please retry';
		}
		else
		{
			echo $data = 'Mail sent successfully';
		}
	}
}
exit;
...
<table id="" class="table orders-place-table">
	...
	<tbody>
		<tr class="item-row">
			...
			<td class="finale_price">₹00.00</td>
			<td>
				<input class="cost form-control discounted_price" name="" value="" placeholder="₹00.00" />
			</td>
			<td>
