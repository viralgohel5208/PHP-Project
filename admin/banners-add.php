...
if(isset($_POST['submit']))
{
	...
	/*if($error == "")
	{
		$query_1 = "SELECT id FROM banners WHERE banner_name = '$banner_name'";
	...
	if($error == "")
	{
		$query_2 = "INSERT INTO `banners`(`app_id`, `banner_name`, `file_name`, `display_order`, `created_at`, `updated_at`, `status`) VALUES ('$app_id', '$banner_name', '$file_name', 0, '$current_datetime', '$current_datetime', '$status')";
		...
		if($result_2)
		{
			...
			$success = "Banner details has been added successfully";
			unset($_POST);
		}
		else
		{
							...
							<div class="panel-body">
								<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="text" id="" class="form-control" name="banner_name" value="<?php if(isset($_POST['banner_name'])) { echo $_POST['banner_name']; } ?>">
										</div>
									</div>
									<div class="form-group">
