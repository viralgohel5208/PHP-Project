...
if(isset($_POST['save']))
{
	...
	$total_measure 		= escapeInputValue($_POST['total_measure']);
	...
	else
	{
		...
		$query1 = "INSERT INTO `products_variant`(`app_id`, `product_id`, `measure_type`, `net_measure`, `total_measure`, `price_raw`, `price_gst`, `price_finale`, `offer_type`, `offer_value`, `expires_at`, `offer_price`, `stock_amount`, `created_at`, `updated_at`, `status`) VALUES ( $app_id, $product_id, $measure_type, $net_measure, $total_measure, $price_raw, '$gst_price_2', '$price', '$offer_type', '$offer_value', '$expires_at', '$offer_price', '$stock_amount', '$current_datetime', '$current_datetime', 1)";
		...
		{
			$_SESSION['msg']['success'] = "Variants has been added successfully";
			header("Location:products-variants.php?cid=$category_id&id=$product_id"); exit;
		}
	}
}
            ...
            <header id="topbar">
				<div class="topbar-left">
					<ol class="breadcrumb">
						...
						<li class="crumb-link">
							<a href="products-variants.php?cid=<?php echo $category_id; ?>&id=<?php echo $product_id; ?>">Variants</a>
						</li>
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<a href="products-variants.php?cid=<?php echo $category_id; ?>&id=<?php echo $product_id; ?>" class="pl5 btn btn-default btn-sm">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="post" action="">
                                    ...
                                    <div class="form-group">
                             		...
                             		<div class="form-group">
                                		<label for="inputStandard" class="col-lg-3 control-label">Total Measure</label>
                                		<div class="col-lg-7">
                                			<input type="text" class="form-control" name="total_measure" value="">
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-8 mt20">
                                            ...
                                            <a href="products-variants.php?cid=<?php echo $category_id;?>&id=<?php echo $product_id;?>" class="btn btn-warning">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
