...
$page_title = "Sales Executives";

if(isset($_POST['delete_id']))
{
	$id = escapeInputValue($_POST['delete_id']);
	
	$check_if_exists = "SELECT id FROM subscription_history WHERE se_id = $id ";
	
	$res_id_exists = mysqli_query($link, $check_if_exists);
	...
	{
		if(mysqli_num_rows($res_id_exists) > 0)
		{
			$_SESSION['msg_error'] = "Can't delete sales executive. SE is assigned to one of the subscription(s).";
		}
		else
		{
			$query_3 = "DELETE FROM `sales_executives` WHERE id = '" . $id . "'" ;
			...
			<header id="topbar">
				<div class="topbar-left">
					<ol class="breadcrumb">
						<li class="crumb-active">
							<a href="sales-executives.php"><?php echo $page_title; ?></a>
						</li>
						<li class="crumb-icon">
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<a href="sales-executives-add.php" class="pl5 btn btn-default btn-sm">
							<i class="fa fa-plus"></i> Add New
						</a>
						<?php /*?><a href="sales-executives-sort.php" class="pl5 btn btn-default btn-sm" style="margin-left: 20px;">
						...
						<div class="panel <?php echo $panel_style; ?>">
							<div class="panel-heading">
								<span class="panel-title">
									<span class="fa fa-dot-circle-o"></span><?php echo $page_title; ?>
								</span>
								<div class="pull-right hidden-xs">
									<a href="sales-executives-add.php" class="btn btn-xs btn-default btn-block mr20" style="margin-top: 8px;">Add New</a>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"sales-executives-datatable.php", // json datasource
