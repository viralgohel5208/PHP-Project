...
if(isset($_POST['delete_id']))
{
	...
	$result = "DELETE FROM packages WHERE id = '" . $id . "'";
			...
			<header id="topbar">
				<div class="topbar-left">
					<ol class="breadcrumb">
						<li class="crumb-active">
							<a href="packages.php"><?php echo $page_title; ?></a>
						</li>
						<li class="crumb-icon">
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<a href="packages-add.php" class="pl5 btn btn-default btn-sm">
						...
						<div class="panel <?php echo $panel_style; ?>">
							<div class="panel-heading">
								<span class="panel-title">
									<span class="fa fa-folder-open"></span><?php echo $page_title; ?>
								</span>
								<div class="pull-right hidden-xs">
									<a href="packages-add.php" class="btn btn-xs btn-default btn-block mr20" style="margin-top: 8px;">Add New</a>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"packages-datatable.php", // json datasource
