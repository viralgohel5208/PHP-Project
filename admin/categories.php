...
if(isset($_POST['delete_id']))
{
	...
	$query_3 = "SELECT id FROM `categories` WHERE id = '" . $id . "'" ;
	...
	if($result_3)
	{
		if ( mysqli_num_rows( $result_3 ) > 0 )
		{
			...
			$result = "DELETE FROM products WHERE category_id = '" . $id . "'";
	
			if(mysqli_query($link, $result))
			{
				$result_4 = "DELETE FROM categories WHERE id = '" . $id . "'";
			...
			<header id="topbar">
				<div class="topbar-left">
					<ol class="breadcrumb">
						<li class="crumb-active">
							<a href="categories.php"><?php echo $page_title; ?></a>
						</li>
						<li class="crumb-icon">
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<a href="categories-add.php" class="pl5 btn btn-default btn-sm">
							<i class="fa fa-plus"></i> Add New
						</a>
						<a href="categories-menu.php" class="pl5 btn btn-default btn-sm" style="margin-left: 20px;">
							<i class="fa fa-signal"></i> Select Menu
						</a>
					</div>
				</div>
			</header>
						...
						<div class="panel <?php echo $panel_style; ?>">
							<div class="panel-heading">
								...
								<div class="pull-right hidden-xs">
									<a href="categories-add.php" class="btn btn-xs btn-default btn-block mr20" style="margin-top: 8px;">Add New</a>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"categories-datatable.php", // json datasource
