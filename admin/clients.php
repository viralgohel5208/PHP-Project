...
if(isset($_POST['delete_id']))
{
	...
	$query_3 = "DELETE FROM `admin` WHERE id = '" . $id . "'" ;
			...
			<header id="topbar">
				<div class="topbar-left">
					<ol class="breadcrumb">
						<li class="crumb-active">
							<a href="clients.php"><?php echo $page_title; ?></a>
						</li>
						<li class="crumb-icon">
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<a href="clients-add.php" class="pl5 btn btn-default btn-sm">
							<i class="fa fa-plus"></i> Add New
						</a>
						<?php /*?><a href="clients-sort.php" class="pl5 btn btn-default btn-sm" style="margin-left: 20px;">
						...
						<div class="panel <?php echo $panel_style; ?>">
							<div class="panel-heading">
								<span class="panel-title">
									<span class="fa fa-group"></span><?php echo $page_title; ?>
								</span>
								<div class="pull-right hidden-xs">
									<a href="clients-add.php" class="btn btn-xs btn-default btn-block mr20" style="margin-top: 8px;">Add New</a>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"clients-datatable.php", // json datasource
