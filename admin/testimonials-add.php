...
if(isset($_POST['submit']))
{
	...
	if($error == "")
	{
		$query_2 = "INSERT INTO `testimonials`(`app_id`, `name`, `position`, `company`, `description`, `file_name`, `created_at`, `updated_at`, `status`) VALUES ('$app_id', '$name', '$position', '$company', '$description', '$file_name', '$current_datetime', '$current_datetime', '$status')";
		...
		if($result_2)
		{
			...
			$success = "Testimonials details has been added successfully";
			unset($_POST);
		}
		else
		{
							...
							<div class="panel-body">
								<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="text" id="" class="form-control" name="name" value="<?php if(isset($_POST['name'])) { echo $_POST['name']; } ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="text" id="" class="form-control" name="position" value="<?php if(isset($_POST['position'])) { echo $_POST['position']; } ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="text" id="" class="form-control" name="company" value="<?php if(isset($_POST['company'])) { echo $_POST['company']; } ?>">
										</div>
									</div>
									...
									<div class="form-group">
											...
											<div class="col-lg-7">
												<textarea class="form-control" name="description" rows="5" ><?php if(isset($_POST['description'])) { echo $_POST['description'];} ?></textarea>
											</div>
										</div>
