...
if(isset($_POST['submit']))
{
	...
	/*if($error == "")
	{
		$query_1 = "SELECT id FROM sliders WHERE slider_name = '$slider_name'";
	...
	if($error == "")
	{
		$query_2 = "INSERT INTO `sliders`(`app_id`, `slider_name`, `file_name`, `display_order`, `created_at`, `updated_at`, `status`) VALUES ('$app_id', '$slider_name', '$file_name', 0, '$current_datetime', '$current_datetime', '$status')";
		...
		if($result_2)
		{
			...
			$success = "Slider details has been added successfully";
			unset($_POST);
		}
		else
		{
							...
							<div class="panel-body">
								<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="text" id="" class="form-control" name="slider_name" value="<?php if(isset($_POST['slider_name'])) { echo $_POST['slider_name']; } ?>">
										</div>
									</div>
									<div class="form-group">
