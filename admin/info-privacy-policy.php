...
if(isset($_POST['submit']))
{
	...
	if($error == "")
	{
		$query_2 = "UPDATE `app_info` SET `privacy_policy` = '$description' WHERE app_id = $app_id";
...
$result = mysqli_query( $link, "SELECT privacy_policy FROM app_info WHERE app_id = $app_id" );
...
if ( $result )
{
	if(mysqli_num_rows($result) > 0)
	{
		...
		$description = $row['privacy_policy'];
	}
	else
	{
