...
if(isset($_POST['delete_id']))
{
	...
	$query_3 = "SELECT id FROM `newsletter` WHERE id = '" . $id . "'" ;
	...
	if($result_3)
	{
		if ( mysqli_num_rows( $result_3 ) > 0 )
		{
			...
			$result = "DELETE FROM newsletter WHERE id = '" . $id . "'";
			...
			<header id="topbar">
				<div class="topbar-left">
					<ol class="breadcrumb">
						<li class="crumb-active">
							<a href="newsletter.php"><?php echo $page_title; ?></a>
						</li>
						<li class="crumb-icon">
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<?php /*?><a href="newsletter-add.php" class="pl5 btn btn-default btn-sm">
						...
						<div class="panel <?php echo $panel_style; ?>">
							<div class="panel-heading">
								<span class="panel-title">
									<span class="fa fa-rss"></span><?php echo $page_title; ?>
								</span>
								<?php /*?><div class="pull-right hidden-xs">
									<a href="newsletter-add.php" class="btn btn-xs btn-default btn-block mr20" style="margin-top: 8px;">Add New</a>
								</div><?php */?>
							</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"newsletter-datatable.php", // json datasource
