...
$where .= " WHERE app_id = 1 AND role_id = 3 ";
...
$sql = "SELECT id, first_name, last_name, email, mobile, status FROM `admin` ";
...
{
	$column_name = 'first_name, last_name ASC';
}
else
{
...
while( $row = mysqli_fetch_row($queryRecords) ) {
	...
	$row[6] .= '<a href="stores-admin-update.php?id='.$pri_id.'" class="btn btn-success btn-xs"> &nbsp;<i class="fa fa-pencil"></i></a>';
