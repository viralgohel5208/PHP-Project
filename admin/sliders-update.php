...
if(isset($_POST['submit']))
{
	...
	$slider_name 		= escapeInputValue($_POST['slider_name']);
	...
	/*if($slider_name == "")
	{
		$error = "Please enter slider name";
	}*/
	...
	{
		//$file_name = "";
		$error = "Please select slider image";
	}
	else
	{
	...
	/*if($error == "")
	{
		$query_1 = "SELECT id FROM sliders WHERE slider_name = '$slider_name' AND id != $item_id";
		
		$result_1 = mysqli_query($link, $query_1);
		
		if (mysqli_num_rows($result_1) > 0)
		{
			$error = "Slider name already exists";
		}
	}*/
	
	if($error == "")
	{
		$query_2 = "UPDATE `sliders` SET `slider_name` = '$slider_name', `file_name` = '$file_name', `updated_at` = '$current_datetime', `status` = '$status' WHERE id = $item_id";
		...
		else
		{
			...
			{
				if($old_file_name != "" && file_exists("../uploads/store-".$app_id."/sliders/" . $old_file_name))
				{
					unlink("../uploads/store-".$app_id."/sliders/" . $old_file_name);
				}
				//else { echo $old_file_name; exit; }
				move_uploaded_file($image_tmp_name, "../uploads/store-".$app_id."/sliders/" . $file_name);
			}

			if($rm_file_name == 1 && $old_file_name != "" && file_exists("../uploads/store-".$app_id."/sliders/".$old_file_name))
			{
				unlink( "../uploads/store-".$app_id."/sliders/".$old_file_name );
			}

			$success = "Slider details has been updated successfully";
			unset($_POST);
			unset($_FILES);
		}
	}
...
if(isset($_GET[ 'id' ] ) )
{
	...
	$query_3 = "SELECT * FROM `sliders` WHERE id = '" . $item_id . "'" ;
...
<body class="form-inputs-page">
							...
							<div class="panel-body">
								<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-lg-7">
											<input type="text" id="" class="form-control" name="slider_name" value="<?php if(isset($_POST['slider_name'])) { echo $_POST['slider_name'];} else { echo $row_3['slider_name']; } ?>">
										</div>
									</div>
									<?php if($row_3['file_name'] != "" && file_exists("../uploads/store-".$app_id."/sliders/".$row_3['file_name'])){ ?>
									<div class="form-group">
										<div class="col-lg-offset-3 col-lg-7">
											<img src="../uploads/store-<?= $app_id ?>/sliders/<?php echo $row_3['file_name']; ?>" width="100px" class=""/>
									...
									<div class="form-group">
										<div class="col-lg-offset-3 col-lg-8">
											...
											<a href="sliders.php" class="btn btn-warning">Cancel</a>
	...
	<form id="delete_form" action="sliders.php" method="post" style="display: hidden">
