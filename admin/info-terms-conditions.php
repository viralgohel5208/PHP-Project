...
if(isset($_POST['submit']))
{
	...
	if($error == "")
	{
		$query_2 = "UPDATE `app_info` SET `terms_conditions` = '$description' WHERE app_id = $app_id";
...
$result = mysqli_query( $link, "SELECT terms_conditions FROM app_info WHERE app_id = $app_id" );
...
if ( $result )
{
	if(mysqli_num_rows($result) > 0)
	{
		...
		$description = $row['terms_conditions'];
	}
	else
	{
