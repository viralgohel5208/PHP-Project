	...
	if($result_3)
	{
		if ( mysqli_num_rows( $result_3 ) > 0 )
		{
			...
			if(mysqli_query($link, $result))
			{
				...
				{
					$_SESSION['msg_error'] = 'E01 - '.$sww;
				}
			}
			else
			{
				$_SESSION['msg_error'] = 'E02 - '.$sww;
			}
		}
	}
...
<body class="tables-basic-page">
				...
				<div class="topbar-left">
					<ol class="breadcrumb">
						<li class="crumb-active">
							<a href="products.php"><?php echo $page_title; ?></a>
						</li>
						<li class="crumb-icon">
						...
						<div class="panel <?php echo $panel_style; ?>">
							<div class="panel-heading">
								...
								<div class="pull-right hidden-xs">
									<a href="products-add.php" class="btn btn-xs btn-default btn-block mr20" style="margin-top: 8px;">Add New</a>
								</div>
							</div>
								...
								<table id="datatable_grid" class="display table table-striped table-bordered">
									<thead>
										<tr>
											...
											<th>Product Name</th>
											<th>Brand Name</th>
											<?php /*?><th style="width: 70px;">Offers</th><?php */?>
	...
	<script type="text/javascript">
		...
		function loadProducts(val) {
			...
			window.location='products.php?id=' + val;
		}
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"products-datatable.php?id=<?php if(isset($_REQUEST['id'])) { echo $_REQUEST['id']; } ?>", // json datasource
