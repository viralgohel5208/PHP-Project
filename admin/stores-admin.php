...
$page_title = "Store Admin";

if(isset($_POST['delete_id']))
{
	$id = escapeInputValue($_POST['delete_id']);
	
	$result = "DELETE FROM stores_admin WHERE admin_id = '" . $id . "' AND app_id = $app_id";
	...
	{
		$result_4 = "DELETE FROM admin WHERE id = '" . $id . "' AND app_id = $app_id";
		$del_res_2 = mysqli_query($link, $result_4);
            ...
            <header id="topbar">
				...
				<div class="topbar-right">
					<div class="ml15 ib va-m" id="">
						<a href="stores-admin-add.php" class="pl5 btn btn-default btn-sm">
						...
						<div class="panel panel-visible panel-dark">
							<div class="panel-heading panel-visible">
								...
								<div class="widget-menu pull-right mr10">
									<div class="btn-group">
										<a href="stores-admin-add.php" class="btn btn-xs btn-default">
    ...
    <script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#datatable_grid').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url :"stores-admin-datatable.php", // json datasource
