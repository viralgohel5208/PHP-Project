										...
										<div class="item-inner">
												...
												<div class="pr-img-area">
													<a href="products-details.php?pro=<?php echo safe_encode($product_id); ?>">
														<figure>
															...
															<img class="hover-img" src="<?php echo $file_name; ?>" alt="">
														</figure>
											...
											<div class="item-info">
												<div class="info-inner">
													<div class="item-title"> <a title="Ipsums Dolors Untra" href="products-details.php?pro=<?php echo safe_encode($product_id); ?>"><?php echo $product_name; ?> </a> </div>
														...
														<div class="item-price">
															<div class="price-box">
																<span class="regular-price">
																	...
																	echo '<span class="price" id="price_'.$product_id.'_'.$item['id'].'"';
