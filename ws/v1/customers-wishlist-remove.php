...
/*
*	Products Listing
* 	URL: http://localhost/ecom/ws/v1/customers-wishlist-remove.php?app_id=1&customer_id=1&auth_token=e8XNj9qQYs7TJgpI4Jyn&variant_id=1&product_id=2
*/
...
if($error_code == 0)
{
	...
	{
		$error_code = 2; $error_string = 'Item is not in the wishlist';
	}
}
