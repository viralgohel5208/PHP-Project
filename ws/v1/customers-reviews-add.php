...
/*
*	Products Listing
* 	URL: http://localhost/ecom/ws/v1/customers-reviews-add.php?app_id=1&customer_id=1&auth_token=e8XNj9qQYs7TJgpI4Jyn&product_id=1&star_rating=1&comment_details=Comment
*/
...
if($error_code == 0)
{
	$pro_query = "SELECT id FROM products_reviews WHERE app_id = '$app_id' AND customer_id = '$customer_id' AND product_id = $product_id";
	...
	{
		$error_code = 4; $error_string = 'Review already exists';
	}
}
