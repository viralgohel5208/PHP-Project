...
/*
*	Products Listing
* 	URL: http://localhost/ecom/ws/v1/customers-reviews-delete.php?app_id=1&customer_id=1&auth_token=e8XNj9qQYs7TJgpI4Jyn&product_id=1
*/
...
if($error_code == 0)
{
	$query_1 = "DELETE FROM `products_reviews` WHERE id = $review_id";
...
if($error_code == 0)
{
	$total_star_count = $total_star_count - $star_rating_db;
